...
void compactacion();
uint32_t calcular_direccion_logia_archivo(int);
uint32_t calcular_direccion_logia_patota(int);
...
char tipoUniversal;
void guaradar_en_memoria_general(void* ,int ,int ,uint32_t pid,char );
...
void* buscar_en_memoria_general(void* ,int , char );
